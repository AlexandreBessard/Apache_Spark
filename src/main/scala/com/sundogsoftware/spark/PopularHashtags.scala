...
object PopularHashtags {
  ...
  def main(args: Array[String]) {
    ...
    // 1 second represent 1 second batch size
    ...
    val hashtags = tweetwords.filter(word => word.startsWith("#")) // Keep #
    ...
    ssc.checkpoint("C:/checkpoint/") // data needs to pick up when something goes wrong
    ssc.start()
