...
// Tuples
// Immutable lists
// Can we use for an entire row of data for example
...
// map Picard to Enterprise-D (Key -> value pairs)
val picardsShip = "Picard" -> "Enterprise-D"
println(picardsShip._1) // Key
println(picardsShip._2) // Value

// Contains different data type which is valid in scala
val aBunchOfStuff = ("Kirk", 1964, true)

// Lists
// Like a tuple, but more functionality
// Must be of same type
// List can not hold different type
val shipList = List("Enterprise", "Defiant", "Voyager", "Deep Space Nine")
//When working with list, the index is 0-based (like java)
println("==> " + shipList(1))
// zero-based

println("-> " + shipList.head)
println(shipList.tail) // All the remaining items beyond the first one.

//Loop every item through the shipList
for (ship <- shipList) {println(ship)}

// map every element to that list to a function
...
//shortcut, place holder -> takes whatever value and compare it to the 3
